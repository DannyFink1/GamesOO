package at.fda.games.d_snowWorld;

import at.fda.games.d_snowWorld.factory.RandomActorFactory;
...
public class Main extends BasicGame {
    ...
    public void init(GameContainer gameContainer) throws SlickException {
        ...
        raf = new RandomActorFactory();
        actors.addAll(raf.getActors(100));
    }
